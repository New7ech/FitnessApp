...
<body>
    ...
    <header class="shop-header" data-site-header>
        ...
        <div class="header-actions" aria-label="Actions boutique">
            ...
            <a class="cart-link" href="#" aria-label="Panier"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 6h15l-2 8H8L6 3H3m6 18a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm9 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/></svg><span>0</span></a>
        </div>
    </header>
    ...
    <main>
        ...
        <section class="split-section">
            ...
            <div class="best-list">
                ...
                @foreach (array_slice($supplements, 0, 3) as $product)
                    <a class="mini-product" href="#">
                        <img src="{{ $product['image'] }}" alt="{{ $product['name'] }}">
                        <span>{{ $product['name'] }}</span>
                        <strong>{{ $product['price'] }}</strong>
